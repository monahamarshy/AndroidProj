...
import com.example.monaproj.Classes.ListAdapter;
import com.example.monaproj.Classes.*;
...
public class ShowProduct extends AppCompatActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    public void getProductToArray(){
        ...
        if(c.getCount()>0){
            ...
            while(!c.isAfterLast()){
                ...
                p.setCategory(c.getString(c.getColumnIndexOrThrow(COLUMN_PRODUCT_CATEGORY)));
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        in.putExtra("Selected_Id", selected_product.getId()+"");
        startActivity(in);
    }
